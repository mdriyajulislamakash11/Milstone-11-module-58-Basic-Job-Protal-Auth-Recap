...
const JobDetails = () => {
    const { title, company, company_logo, description, requirements, salaryRange, applicationDeadline, location } = useLoaderData();
    ...
    return (
        <div className="max-w-4xl mx-auto my-10 bg-white rounded-lg shadow-md p-8 border border-gray-200">
            ...
            <div className="flex flex-wrap items-center justify-between border-t pt-4 text-gray-700">
                ...
                <p><strong>Salary:</strong> {salaryRange?.min} - {salaryRange?.max} {salaryRange?.currency}</p>
